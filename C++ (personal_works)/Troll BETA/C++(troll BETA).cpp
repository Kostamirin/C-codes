...
bool foundRus(const std::string &text);
void Language(std::string &english);
bool theDick(std::string &text);
bool theCum(std::string &text);
bool theFuckyou(std::string &text);
bool theNull(std::string &text);
bool theBoollshit(std::string &text);
bool theNigger(std::string &text);
bool theAss(std::string &text);
bool theSecret(std::string &text);
bool theGood(std::string &text);
void theEndEng(originalText &originalText);
void theEndRus(originalText &originalText);
void thePovtor(int *povtor, std::string text,originalText saveText, int &NOpovtor);
...
if(english == "E"|| english == "e"|| english =="Е"|| english == "е"){
    thePovtor(povtor, text, saveText, NOpovtor);
...
bool theNull(std::string &text){
    if(text == "4r5e"||text == "5h1t"|| text == "5hit" || text == "5gay5"){
        return true;
    }
    else{
        return false;
...
bool theBoollshit(std::string &text){
    if(text =="boolshit"||text == "boolsit!" || text =="doolshit"|| text == "boolchit"||text =="boolcit"){
        return true;
    }
    else{
        return false;
...
bool theNigger(std::string &text){
    if(text =="higger"|| text =="nigger"|| text =="niger" || text == "higer"|| text == "gey"||text == "gay" || text =="slate"){
        return true;
    }
    else{
        return false;
...
bool theAss(std::string &text){
    if(text == "ass"|| text == "asshole"|| text =="yourasshole"||text == "youareasshole"|| text == "youareass"||text == "youasshole"|| text == "ashole"||text =="youareashole"||text =="youas"||text =="youareas"||text =="youareass"){
        return true;
    }
    else{
        return false;
...
bool theSecret(std::string &text){
    if(text == "iwantsecret" || text =="iwannasecret"){
        return true;
    }
    else{
        return false;
...
bool theGood(std::string &text){
    if(text == "i`mgood"|| text == "iamgood" || text == "megood"|| text == "good" || text == "cool"|| text == "imgood"){
        return true;
    }
    else{
        return false;
...
void thePovtor(int *povtor, std::string text,originalText saveText, int &NOpovtor){
    switch(*povtor){
        ...
        break;
        default:
            std::cout <<"My bad, you find the bug, sorry";
        break;
        }
}
